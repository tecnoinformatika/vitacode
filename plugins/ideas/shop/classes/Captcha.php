...
//        }
        ...
        for ($i = 0; $i<$this->char_length; $i++) {
            ...
            $font = plugins_path('/ideas/shop/classes/'.$this->font_path) . "/" . $sel_font;
...
//        ImageJPeg($img);
        ...
        $randomName = IdeasShop::generateRandomString(6);
    ...
    {
        if (false !== ($dir = opendir(plugins_path('/ideas/shop/classes/'.$dir)))) {
            $files = array();
